...
class VidVRD(Dataset):
    def __init__(self, mode, datasize, video_id=None, data_path=None, filter_nonperson_box_frame=True, filter_small_box=False):
        ...
        f.close()
        self.attention_relationships = self.relationship_classes[0:16]
        self.spatial_relationships = self.relationship_classes[16:116]
        self.contacting_relationships = self.relationship_classes[116:]
    ...
    def __getitem__(self, index):
        ...
        for idx, name in enumerate(frame_names):
            ...
            im = imread(os.path.join(self.frames_path, frame_name)) # channel h,w,3
            im = im[:, :, ::-1] # rgb -> bgr
